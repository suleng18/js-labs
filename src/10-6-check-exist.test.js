import { checkIfAllEveryV1, checkIfAllEveryV2 } from './9-7.js';
...
describe('checkIfAllEveryV1', () => {
  ...
  test('should return false when array has some even number', () => {
    expect(checkIfAllEveryV1([1, 2, 3])).toBe(false);
  });

  test('should return true when array has all even number', () => {
    expect(checkIfAllEveryV1([2, 4, 6])).toBe(true);
  });
});
...
describe('checkIfAllEveryV2', () => {
  ...
  test('should return false when array has some even number', () => {
    expect(checkIfAllEveryV2([1, 2, 3])).toBe(false);
  });

  test('should return true when array has all even number', () => {
    expect(checkIfAllEveryV2([2, 4, 6])).toBe(true);
  });
});
